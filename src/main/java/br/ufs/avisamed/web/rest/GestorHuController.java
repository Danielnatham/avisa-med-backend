...
public class GestorHuController {

    private static final Logger log = LoggerFactory.getLogger(GestorHuController.class);
    ...
    public GestorHuController(GestorHuService gestorHuService, GestorHuRepository gestorHuRepository) {
