...
public class CidadaoIdentificadoController {

    private static final Logger log = LoggerFactory.getLogger(CidadaoIdentificadoController.class);
    ...
    public CidadaoIdentificadoController(
